 ...
 */
package com.lxzh.basic.framework.core.exception.enums;

import com.lxzh.basic.framework.core.annotion.ExpEnumType;
import com.lxzh.basic.framework.core.consts.ExpEnumConstant;
...
public enum AuthExceptionEnum implements AbstractBaseExceptionEnum {
     ...
     * 账号或密码为空
     */
    ACCOUNT_OLDPWD_ERROR(10, "密码不正确！"),
    ACCOUNT_OLDANDNEW_IS_SAME(11, "不能与原密码相同！"),
    ACCOUNT_EXCIPTION(12, "账号异常,请联系管理员！"),
    ACCOUNT_HAS_LOGIN_BY_OTHER(13, "您的账户已在其他位置登录，请重新登录"),
    ;
