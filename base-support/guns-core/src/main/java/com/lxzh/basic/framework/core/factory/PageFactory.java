 ...
 */
package com.lxzh.basic.framework.core.factory;

import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import com.lxzh.basic.framework.core.pojo.base.model.PageQuery;
...
public class PageFactory {
    ...
    public static <T> Page<T> createPage(PageQuery pageQuery) {
        ...
        if (pageQuery != null && Objects.nonNull(pageQuery.getPageSize())) {
            pageSize = pageQuery.getPageSize();
        }

        if (pageQuery != null && Objects.nonNull(pageQuery.getPageNo())) {
        ...
        if (StrUtil.isBlank(pageQuery.getSort())) {
            return page;
        }
