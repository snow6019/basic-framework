 ...
 */
package com.lxzh.basic.framework.sys.modular.emp.service.impl;
...
import com.lxzh.basic.framework.sys.modular.emp.entity.SysEmpExtOrgPos;
import com.lxzh.basic.framework.sys.modular.emp.mapper.SysEmpExtOrgPosMapper;
...
public class SysEmpExtOrgPosPosServiceImpl extends ServiceImpl<SysEmpExtOrgPosMapper, SysEmpExtOrgPos> implements SysEmpExtOrgPosService {
    ...
    public void addOrEdit(Long empId, List<Dict> extIdList) {
        ...
        //保存附属信息
        if (CollectionUtil.isNotEmpty(extIdList)) {
