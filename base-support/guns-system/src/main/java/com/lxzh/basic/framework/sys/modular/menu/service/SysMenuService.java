 ...
 */
package com.lxzh.basic.framework.sys.modular.menu.service;
...
public interface SysMenuService extends IService<SysMenu> {
     ...
     */
    List<String> getLoginPermissions(Long userId,List<Long> roleIdList,List<Long> menuIdList);
     ...
     * @date 2020/3/13 16:26
     */
    List<Long> getLoginPermissionIds(Long userId, SysUser sysUser, List<Long> roleIdList, List<Long> menuIdList);
     ...
     */
    List<LoginMenuTreeNode> getLoginMenusAntDesign(Long userId, String appCode, SysUser sysUser);
    ...
    SysMenu addReHis(SysMenuParam sysMenuParam);
