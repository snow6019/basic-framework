 ...
 */
package com.lxzh.basic.framework.sys.core.context;
...
import com.lxzh.basic.framework.core.context.system.SystemContext;
...
public class SystemContextImpl implements SystemContext {
    ...
    public Map<String, String> getDictCodeNameMap(String dictTypeCode) {
        return sysDictDataService.getDictCodeNameMap(dictTypeCode);
    }
