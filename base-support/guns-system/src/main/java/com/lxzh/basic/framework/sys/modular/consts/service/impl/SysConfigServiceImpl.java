 ...
 */
package com.lxzh.basic.framework.sys.modular.consts.service.impl;

import cn.hutool.core.bean.BeanUtil;
import cn.hutool.core.util.ObjectUtil;
import com.alibaba.fastjson.JSON;
import com.lxzh.basic.framework.sys.modular.consts.mapper.SysConfigMapper;
import com.lxzh.basic.framework.sys.modular.consts.service.SysConfigService;
import com.lxzh.basic.framework.core.context.constant.ConstantContext;
...
import com.lxzh.basic.framework.sys.modular.consts.entity.SysConfig;
import com.lxzh.basic.framework.sys.modular.consts.enums.SysConfigExceptionEnum;
import com.lxzh.basic.framework.sys.modular.consts.param.SysConfigParam;
...
public class SysConfigServiceImpl extends ServiceImpl<SysConfigMapper, SysConfig> implements SysConfigService {
    ...
    @Override
    public List<String> getReserveMust() {
        String reserveMust = ConstantContextHolder.getSysConfig("GUNS_PLAYGROUND_RESERVE_MUST",String.class,false);
        if(StringUtils.isNotBlank(reserveMust)){
            return JSON.parseArray(reserveMust,String.class);
        }
