 ...
 */
package com.lxzh.basic.framework.sys.modular.role.service;
...
public interface SysRoleService extends IService<SysRole> {
     ...
     */
    Boolean add(SysRoleParam sysRoleParam);
     ...
     * @date 2020/3/28 14:54
     */
    Boolean delete(SysRoleParam sysRoleParam);
     ...
     * @date 2020/3/28 14:54
     */
    Boolean edit(SysRoleParam sysRoleParam);
     ...
     * @date 2020/3/26 9:50
     */
    SysRoleResult detail(SysRoleParam sysRoleParam);
     ...
     */
    Boolean grantMenu(SysRoleParam sysRoleParam);
     ...
     */
    Boolean grantData(SysRoleParam sysRoleParam);
