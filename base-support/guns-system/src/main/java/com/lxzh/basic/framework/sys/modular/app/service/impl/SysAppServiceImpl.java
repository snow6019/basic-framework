 ...
 */
package com.lxzh.basic.framework.sys.modular.app.service.impl;
...
import com.lxzh.basic.framework.sys.modular.app.enums.SysAppExceptionEnum;
...
import com.lxzh.basic.framework.sys.modular.app.mapper.SysAppMapper;
...
public class SysAppServiceImpl extends ServiceImpl<SysAppMapper, SysApp> implements SysAppService {
    ...
    @Override
    public List<Dict> getLoginApps(Long userId, SysUser sysUser) {
