 ...
 */
package com.lxzh.basic.framework.sys.modular.role.result;
...
public class SysRoleResult {
    ...
    /**
     * 登录端口类型1-后台管理,2-门店终端,3-员工微信端
     */
    @ApiModelProperty("登录端口类型1-后台管理,2-门店终端,3-员工微信端")
