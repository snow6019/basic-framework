...
import com.lxzh.basic.framework.core.enums.LogicTypeEnum;
...
public class PermissionAop {
     ...
     */
    @Pointcut("@annotation(com.lxzh.basic.framework.core.annotion.Permission)")
    ...
    public void doPermission(JoinPoint joinPoint) {
        ...
        boolean hasUriPermission = LoginContextHolder.me().hasPermission(request.getRequestURI(), request.getMethod());
        if (!hasUriPermission) {
