 ...
 */
package com.lxzh.basic.framework.sys.modular.dict.service;
...
public interface SysDictDataService extends IService<SysDictData> {
    ...
    Map<String, List<SysDictData>> findSysDictDataMap(String... dictTypeCodes);

    Map<String, String> getDictCodeNameMap(String dictTypeCode);

    String getDictCodeName(String dictTypeCode, String dictCode);

    List<DictNode> getDictNodes(String type);
}
