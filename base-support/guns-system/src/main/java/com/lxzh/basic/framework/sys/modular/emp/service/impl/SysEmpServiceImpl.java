...
import com.lxzh.basic.framework.sys.modular.emp.mapper.SysEmpMapper;
import com.lxzh.basic.framework.sys.modular.emp.result.SysEmpInfo;
import com.lxzh.basic.framework.sys.modular.emp.entity.SysEmp;
...
public class SysEmpServiceImpl extends ServiceImpl<SysEmpMapper, SysEmp> implements SysEmpService {
    ...
    public void addOrUpdate(SysEmpParam sysEmpParam) {
        ...
        if (StrUtil.isBlank(sysEmp.getOrgName())) {
