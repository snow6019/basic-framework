 ...
 */
package com.lxzh.basic.framework.sys.modular.user.service;
...
public interface SysUserService extends IService<SysUser> {
     ...
     *
     * @param account 账号
     * @param referType 用户类型1-管理员 2-客户经理 3-业务员 4-客户
     * @return 用户
     * @author xuyuxiang
     * @date 2020/3/11 17:51
     */
    SysUser getUserByCount(String account,Integer referType);
     ...
     * @date 2020/3/23 9:26
     */
    Boolean add(SysUserParam sysUserParam);
     ...
     * @date 2020/3/23 9:26
     */
    Boolean delete(SysUserParam sysUserParam);
     ...
     * @date 2020/3/23 9:26
     */
    Boolean edit(SysUserParam sysUserParam);
     ...
     */
    Boolean changeStatus(SysUserParam sysUserParam);
     ...
     */
    Boolean grantRole(SysUserParam sysUserParam);
     ...
     * @date 2020/3/28 16:54
     */
    Boolean grantData(SysUserParam sysUserParam);
     ...
     * @date 2020/4/1 14:43
     */
    Boolean updateInfo(SysUserParam sysUserParam);
     ...
     * @date 2020/4/1 14:44
     */
    Boolean updatePwd(SysUserParam sysUserParam);
     ...
     */
    Boolean resetPwd(SysUserParam sysUserParam);
     ...
     */
    Boolean updateAvatar(SysUserParam sysUserParam);
    ...
    SysUser getUserAvatar(Integer code, Long id);

    SysUser getUserByOpenId(String openid, Integer loginType);

    SysUser getUserByAcount(String account, Integer loginPortType);

    SysUser getUserByPhone(String phone, Integer loginType);
}
