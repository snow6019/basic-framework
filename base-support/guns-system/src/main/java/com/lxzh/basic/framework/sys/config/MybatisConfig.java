...
import com.lxzh.basic.framework.sys.core.mybatis.dbid.GunsDatabaseIdProvider;
import com.lxzh.basic.framework.sys.core.mybatis.fieldfill.CustomMetaObjectHandler;
import com.lxzh.basic.framework.sys.core.mybatis.sqlfilter.DemoProfileSqlInterceptor;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.lxzh.**.mapper"})
