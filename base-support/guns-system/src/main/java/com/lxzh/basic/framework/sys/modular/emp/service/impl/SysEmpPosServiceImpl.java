...
import com.lxzh.basic.framework.sys.modular.emp.mapper.SysEmpPosMapper;
import com.lxzh.basic.framework.sys.modular.emp.entity.SysEmpPos;
...
public class SysEmpPosServiceImpl extends ServiceImpl<SysEmpPosMapper, SysEmpPos> implements SysEmpPosService {
    ...
    public void addOrEdit(Long empId, List<Long> posIdList) {
        ...
        //保存职位信息
        if (CollectionUtil.isNotEmpty(posIdList)) {
